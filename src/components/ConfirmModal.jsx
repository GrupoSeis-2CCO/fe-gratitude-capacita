...
export default function ConfirmModal({ open, title = 'Confirmar', message = 'Tem certeza?', onCancel, onConfirm, confirmLabel = 'Confirmar', cancelLabel = 'Cancelar', hideCancel = false }) {
  if (!open) return null;
